# 🚀 Yufeed API Documentation

Welcome to the Yufeed Intelligence API. This documentation provides details on how to integrate with the Yufeed platform programmatically.

## 🔑 Authentication

Most endpoints require authentication. Yufeed supports two methods:
